...
const Quizzes = () => {
  return (
    <div>
      <Link to="/admin/exercise" className="flex items-center px-4 py-2 rounded-md text-lg hover:bg-white/5 group">
        <div className="flex items-center gap-2 border-b-2 border-transparent group-hover:border-[#E4D161] transition-colors">
          ...
          <span className="text-white transition-colors group-hover:text-[#E4D161]">Manage Exercises</span>
        </div>
      </Link>
    </div>
  )
